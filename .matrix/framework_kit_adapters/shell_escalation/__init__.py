...
ASSET_ID = "as_codex_shell_escalation"
ACCEPTED_VERSION = "v0001_initial"
EXPECTED_PLAN_HASH = "b3530e55bfc1c9dfa358a5952b21a139d911d2d03d0a6a66a9c55c16eca043db"
EXPECTED_COUNT = 14
...
SOURCE_FILES = ('BUILD.bazel', 'Cargo.toml', 'README.md', 'patches/zsh-exec-wrapper.patch', 'src/bin/main_execve_wrapper.rs', 'src/lib.rs', 'src/unix/escalate_client.rs', 'src/unix/escalate_protocol.rs', 'src/unix/escalate_server.rs', 'src/unix/escalation_policy.rs', 'src/unix/execve_wrapper.rs', 'src/unix/mod.rs', 'src/unix/socket.rs', 'src/unix/stopwatch.rs')
