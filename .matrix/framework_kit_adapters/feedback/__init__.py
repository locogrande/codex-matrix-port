...
ASSET_ID = "as_codex_feedback"
COMPONENT_ID = ASSET_ID
ACCEPTED_VERSION = "v0001_initial"
EXPECTED_PLAN_HASH = "69b5e59fc2dccd333947cbd43821125e219c2e41aa0334d4fb5176f3b09c5e1d"
...
SOURCE_FILES = ('BUILD.bazel', 'Cargo.toml', 'src/feedback_diagnostics.rs', 'src/lib.rs')
...
def gate_probe() -> bool:
    ...
    return (ENGINE_ROOT.is_dir() and manifest().get("status") == "accepted" and manifest().get("expected_plan_hash") == EXPECTED_PLAN_HASH and len(rows) == 4
