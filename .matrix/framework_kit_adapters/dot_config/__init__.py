...
ASSET_ID = "as_codex_.config"
COMPONENT_ID = "dot_config"
ACCEPTED_VERSION = "v0001_initial"
EXPECTED_PLAN_HASH = "cd9414a2897eb120821a92198820f583198eec2a18fd8423ca4b9bbf226c3b7f"
ROOT = Path(__file__).resolve().parents[3]
VERSION_ROOT = ROOT / "library/source_assets/components/dot_config/versions" / ACCEPTED_VERSION
SOURCE_ROOT = VERSION_ROOT / "source"
MANIFEST_PATH = VERSION_ROOT / "manifest.json"
SOURCE_MAP_PATH = VERSION_ROOT / "source_map.json"
SOURCE_FILES = ('nextest.toml',)
