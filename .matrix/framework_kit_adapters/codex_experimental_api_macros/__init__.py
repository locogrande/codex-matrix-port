...
ASSET_ID = "as_codex_codex_experimental_api_macros"
ACCEPTED_VERSION = "v0001_initial"
EXPECTED_PLAN_HASH = "b98d7c3ad34f58f67aed81d55ead59f1b13993b8172d0d86b3acf4ae6137d8e4"
...
def gate_probe() -> bool:
    ...
    return (ENGINE_ROOT.is_dir() and manifest().get("expected_plan_hash") == EXPECTED_PLAN_HASH and len(rows) == 3
