...
ASSET_ID = "as_codex_agent_graph_store"
ACCEPTED_VERSION = "v0001_initial"
EXPECTED_PLAN_HASH = "d2fc7805a981e40b7b8f4a2f5c7b927360a41035c5a084b84e5382b0c5000696"
...
SOURCE_FILES = ("BUILD.bazel", "Cargo.toml", "src/error.rs", "src/lib.rs", "src/local.rs", "src/store.rs", "src/types.rs")
...
def gate_probe() -> bool:
    ...
    return (ENGINE_ROOT.is_dir() and manifest().get("expected_plan_hash") == EXPECTED_PLAN_HASH and len(rows) == 7
