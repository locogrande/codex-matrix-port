...
ASSET_ID = "as_codex_aws_auth"
COMPONENT_ID = "aws_auth"
ACCEPTED_VERSION = "v0001_initial"
EXPECTED_PLAN_HASH = "5ebd8533f2735482acc09fc855fc48d04c4d9c89d97c570ace8424c60aa1e26e"
ROOT = Path(__file__).resolve().parents[3]
VERSION_ROOT = ROOT / "library/source_assets/components/aws_auth/versions" / ACCEPTED_VERSION
SOURCE_ROOT = VERSION_ROOT / "source"
MANIFEST_PATH = VERSION_ROOT / "manifest.json"
SOURCE_MAP_PATH = VERSION_ROOT / "source_map.json"
SOURCE_FILES = ('BUILD.bazel', 'Cargo.toml', 'src/config.rs', 'src/lib.rs', 'src/signing.rs')
