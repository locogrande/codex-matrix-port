...
ASSET_ID = "as_codex_.github"
COMPONENT_ID = "dot_github"
ACCEPTED_VERSION = "v0001_initial"
EXPECTED_PLAN_HASH = "31f48158fd2bfb97d822b5fafc3faf90d20ecc5357c1e3818943302986d2b67e"
ROOT = Path(__file__).resolve().parents[3]
VERSION_ROOT = ROOT / "library/source_assets/components/dot_github/versions" / ACCEPTED_VERSION
SOURCE_ROOT = VERSION_ROOT / "source"
MANIFEST_PATH = VERSION_ROOT / "manifest.json"
SOURCE_MAP_PATH = VERSION_ROOT / "source_map.json"
SOURCE_FILES = ('workflows/cargo-audit.yml',)
