...
ASSET_ID = "as_codex_analytics"
ACCEPTED_VERSION = "v0001_initial"
EXPECTED_PLAN_HASH = "cf3b41b225189a9fb5e0e1f887935b6d49f31daed7cfc67307069232aa866cf1"
...
SOURCE_FILES = ("BUILD.bazel", "Cargo.toml", "src/accepted_lines.rs", "src/analytics_client_tests.rs", "src/client.rs", "src/client_tests.rs", "src/events.rs", "src/facts.rs", "src/lib.rs", "src/reducer.rs")
...
def gate_probe() -> bool:
    ...
    return (ENGINE_ROOT.is_dir() and manifest().get("expected_plan_hash") == EXPECTED_PLAN_HASH and len(rows) == 10
