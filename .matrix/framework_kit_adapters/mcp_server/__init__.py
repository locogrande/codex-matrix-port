...
ASSET_ID = "as_codex_mcp_server"
ACCEPTED_VERSION = "v0001_initial"
EXPECTED_PLAN_HASH = "8f213ea72f95069baac6420d468047682a89c0193b598d392c403d2a4d8d97bc"
EXPECTED_COUNT = 19
...
SOURCE_FILES = ('BUILD.bazel', 'Cargo.toml', 'src/codex_tool_config.rs', 'src/codex_tool_runner.rs', 'src/exec_approval.rs', 'src/lib.rs', 'src/main.rs', 'src/message_processor.rs', 'src/outgoing_message.rs', 'src/patch_approval.rs', 'tests/all.rs', 'tests/common/BUILD.bazel', 'tests/common/Cargo.toml', 'tests/common/lib.rs', 'tests/common/mcp_process.rs', 'tests/common/mock_model_server.rs', 'tests/common/responses.rs', 'tests/suite/codex_tool.rs', 'tests/suite/mod.rs')
