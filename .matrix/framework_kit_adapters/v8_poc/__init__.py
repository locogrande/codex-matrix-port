...
ASSET_ID = "as_codex_v8_poc"
COMPONENT_ID = "v8_poc"
ACCEPTED_VERSION = "v0001_initial"
EXPECTED_PLAN_HASH = "f476fac6cfb6dd50b5337d4ef1ed4653b9e43698ba04e8349ae7d091b8bdb110"
ROOT = Path(__file__).resolve().parents[3]
VERSION_ROOT = ROOT / "library/source_assets/components/v8_poc/versions" / ACCEPTED_VERSION
SOURCE_ROOT = VERSION_ROOT / "source"
MANIFEST_PATH = VERSION_ROOT / "manifest.json"
SOURCE_MAP_PATH = VERSION_ROOT / "source_map.json"
SOURCE_FILES = ('.gitignore', 'BUILD.bazel', 'Cargo.toml', 'src/lib.rs')
