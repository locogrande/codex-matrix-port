...
ASSET_ID = "as_codex_cli_2"
ACCEPTED_VERSION = "v0001_initial"
EXPECTED_PLAN_HASH = "7284aa9ef1c33a402cf8c583e77963132fb92c572be50267dd8095625e93642a"
EXPECTED_COUNT = 9
...
SOURCE_FILES = ('.gitignore', 'bin/codex.js', 'bin/rg', 'package.json', 'scripts/README.md', 'scripts/build_npm_package.py', 'scripts/init_firewall.sh', 'scripts/install_native_deps.py', 'scripts/run_in_container.sh')
