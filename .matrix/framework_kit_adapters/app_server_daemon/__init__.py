...
ASSET_ID = "as_codex_app_server_daemon"
ACCEPTED_VERSION = "v0001_initial"
EXPECTED_PLAN_HASH = "08ce71efac33e0ccdb0d8a1916fec3d99eb0330ff782844cd04f70121e9a849a"
EXPECTED_COUNT = 13
...
SOURCE_FILES = ('BUILD.bazel', 'Cargo.toml', 'README.md', 'src/backend/mod.rs', 'src/backend/pid.rs', 'src/backend/pid_tests.rs', 'src/client.rs', 'src/lib.rs', 'src/managed_install.rs', 'src/managed_install_tests.rs', 'src/settings.rs', 'src/update_loop.rs', 'src/update_loop_tests.rs')
