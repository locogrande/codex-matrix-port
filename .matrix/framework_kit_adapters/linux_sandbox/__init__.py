...
ASSET_ID = "as_codex_linux_sandbox"
ACCEPTED_VERSION = "v0001_initial"
EXPECTED_PLAN_HASH = "6610974b1f6990e6251417c840da407af5440f244aaae6bdaca32c0ee386791e"
EXPECTED_COUNT = 19
...
SOURCE_FILES = ('BUILD.bazel', 'Cargo.toml', 'README.md', 'build.rs', 'src/bazel_bwrap.rs', 'src/bundled_bwrap.rs', 'src/bwrap.rs', 'src/exec_util.rs', 'src/landlock.rs', 'src/launcher.rs', 'src/lib.rs', 'src/linux_run_main.rs', 'src/linux_run_main_tests.rs', 'src/main.rs', 'src/proxy_routing.rs', 'tests/all.rs', 'tests/suite/landlock.rs', 'tests/suite/managed_proxy.rs', 'tests/suite/mod.rs')
