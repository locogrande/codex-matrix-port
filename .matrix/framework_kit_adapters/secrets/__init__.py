...
ASSET_ID = "as_codex_secrets"
COMPONENT_ID = "secrets"
ACCEPTED_VERSION = "v0001_initial"
EXPECTED_PLAN_HASH = "7ac4394172649b1e4afd59899d7b716643437ebd82e221ed161be73f07f2698d"
ROOT = Path(__file__).resolve().parents[3]
VERSION_ROOT = ROOT / "library/source_assets/components/secrets/versions" / ACCEPTED_VERSION
SOURCE_ROOT = VERSION_ROOT / "source"
MANIFEST_PATH = VERSION_ROOT / "manifest.json"
SOURCE_MAP_PATH = VERSION_ROOT / "source_map.json"
SOURCE_FILES = ('BUILD.bazel', 'Cargo.toml', 'src/lib.rs', 'src/local.rs', 'src/sanitizer.rs')
