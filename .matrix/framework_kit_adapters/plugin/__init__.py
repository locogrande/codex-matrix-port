...
ASSET_ID = "as_codex_plugin"
COMPONENT_ID = ASSET_ID
ACCEPTED_VERSION = "v0001_initial"
EXPECTED_PLAN_HASH = "63e6e51a37de4e5dc3eae73ee65d23f971faba70604e501bf3d7cbfe34f16b3e"
...
SOURCE_FILES = ("BUILD.bazel", "Cargo.toml", "src/lib.rs", "src/load_outcome.rs", "src/plugin_id.rs")
...
def gate_probe() -> bool:
    ...
    return (ENGINE_ROOT.is_dir() and manifest().get("status") == "accepted" and manifest().get("expected_plan_hash") == EXPECTED_PLAN_HASH and len(rows) == 5
