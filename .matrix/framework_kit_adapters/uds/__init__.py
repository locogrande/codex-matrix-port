...
ASSET_ID = 'as_codex_uds'
COMPONENT_ID = ASSET_ID
ACCEPTED_VERSION = 'v0001_initial'
EXPECTED_PLAN_HASH = 'a24ca79041791ee16ee03facedde308ef2b3994e4fbb8dd4ad29be2a30273d51'
EXPECTED_COUNT = 4
...
SOURCE_FILES = ('BUILD.bazel', 'Cargo.toml', 'src/lib.rs', 'src/lib_tests.rs')
