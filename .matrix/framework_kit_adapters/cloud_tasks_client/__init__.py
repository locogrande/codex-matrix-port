...
ASSET_ID = "as_codex_cloud_tasks_client"
ACCEPTED_VERSION = "v0001_initial"
EXPECTED_PLAN_HASH = "6f6d45c1e067c3b1a62735baaaebec8edb53074651bf2c8663a3d193e337a9ab"
...
SOURCE_FILES = ("BUILD.bazel", "Cargo.toml", "src/api.rs", "src/http.rs", "src/lib.rs")
...
def gate_probe() -> bool:
    ...
    return (ENGINE_ROOT.is_dir() and manifest().get("expected_plan_hash") == EXPECTED_PLAN_HASH and len(rows) == 5
